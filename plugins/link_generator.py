...
async def batch(client: Client, message: Message):
    ...
    await second_message.reply_text(f"<b><blockquote>🧑‍💻 Here is your code : \n<code>{base64_string}</code></blockquote></b>\n\n<b><blockquote>🔗 Here is your link :</b>\n{link}</blockquote>", quote=True, reply_markup=reply_markup)
...
async def link_generator(client: Client, message: Message):
    ...
    await channel_message.reply_text(f"<b><blockquote>🧑‍💻 Here is your code : \n<code>{base64_string}</code></blockquote></b>\n\n<b><blockquote>🔗 Here is your link : </b>\n{link}</blockquote>", quote=True, reply_markup=reply_markup)
